  ...
  return (
    <>
      <section class="overflow-hidden relative bg-white dark:bg-gray-900 min-h-[700px] flex">
        <div class="gap-8  px-4 mx-auto max-w-screen-xl  flex ">
          <div class="col-span-8 py-8 lg:py-16 flex flex-col justify-center">
          ...
          <div class="hidden  w-full h-full xl:block">
            <img
